...
description = "Alkart Wizard L220-XII";
vendor = "Citizen";
...
longDescription = "Interface L220-XII with Akart CNC Wizard";
...
setupMachine = function () {
  ...
  var cAxisMain = createAxis({ coordinate: 2, table: true, axis: [0, 0, -1], cyclic: false, range: [0,99999], preference: 0 }); // C axis is modal between primary and secondary spindle
